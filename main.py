...
River list is never handed to animals 

Since the code is not intended as an interface for public use, we decided against using private variables. 
However, this could be implemented easily
